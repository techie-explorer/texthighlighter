  ...
  function testCallbacks(params) {
    it(params.title, function() {
      ...
      if (params.onBeforeHighlight) {
        callbackParams.onBeforeHighlight = params.onBeforeHighlight;
      }
      if (params.onAfterHighlight) {
        callbackParams.onAfterHighlight = params.onAfterHighlight;
      }
      if (params.onRemoveHighlight) {
        callbackParams.onRemoveHighlight = params.onRemoveHighlight;
      }

      hl = sandbox.init(callbackParams);
