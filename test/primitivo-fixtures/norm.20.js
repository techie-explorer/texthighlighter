fixtures.register("20", function() {
  DIV(
    ...
    B(HIGHLIGHT({ color: "red", marked: true }, "dolor")),
    HIGHLIGHT({ color: "red", marked: true }, " sit "),
    B(HIGHLIGHT({ color: "red", marked: true }, "amet"), " consectetur"),
    " adipiscing elit.",
  );
});
...
fixtures.register("20.merge", function() {
  DIV(
    ...
    B(HIGHLIGHT({ color: "red" }, "dolor")),
    HIGHLIGHT({ color: "red" }, " sit "),
    B(HIGHLIGHT({ color: "red" }, "amet"), " consectetur"),
    " adipiscing elit.",
  );
});
